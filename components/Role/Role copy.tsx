...
import { FC, useState, useCallback, useMemo, ChangeEvent, useRef, useEffect, memo } from 'react'
...
export const Role: FC = () => {
  ...
  const MemoizedStyledTextField = useMemo(() => memo(StyledTextField), []);
    ...
    <Box className="role-main p-4" sx={{ color: "#ffffff" }}>
      <Box className="mb-4">
        ...
        <Button
          onClick={editRole}
          variant="contained"
          className="w-full sm:w-auto mt-4 md:ml-4"
        ...
        <DialogContent>
          ...
          <Box className="space-y-4 mt-4">
            ...
            <Box className="flex items-center space-x-2">
              ...
              {isRecording && <span>录音中: {recordingTime}s</span>}
              <input
                type="file"
                accept="audio/*"
